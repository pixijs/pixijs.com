import{m as Ie,T as w,o as $e,p as L,w as $,q as ge,s as xe,R as Le,t as Re,v as be,M as U,V as ve,B as we,x as ke,y as Ee,E as ee,z as te,A as ye,H as J,I as Se,J as Ae,N as Te,G as Fe,S as Y,K as re,L as Oe,O as Ue,P as je,Q as Ve,W as Ne,X as ze,Y as We,Z as He,_ as Ye,$ as Ke,a0 as qe,a as Xe,a1 as Je,a2 as Ze,a3 as Qe,l as et}from"./index-50evykZy.js";import{S as _e,a as tt,C as rt,e as at,c as ot,b as st,g as nt,d as ae,L as it,V as lt,H as ct,t as ut,r as Be,f as dt,h as ht,i as ft,j as pt,k as mt,n as gt,v as xt,l as bt,m as vt,o as wt,p as yt,q as St,s as Tt,u as _t,M as Bt,w as Dt,G as Gt,x as Mt,y as Pt,z as Ct,A as It,B as $t,D as Lt,E as Rt,F as kt}from"./View3DGCRegistry-LdJ6Za-i.js";import"./RenderTexture-G8_TWQt5.js";const Et=4;var At=class{data;_source;_texture;_capacity=0;constructor(e=256){this.ensureCapacity(e)}get texture(){return this._texture}get capacity(){return this._capacity}ensureCapacity(e){if(e<=this._capacity)return;let t=Math.max(256,this._capacity);for(;t<e;)t*=2;this._capacity=t;const r=Math.min(t,$e),a=Math.ceil(t/r);if(this.data=new Float32Array(r*a*Et),!this._source){this._source=new Ie({resource:this.data,width:r,height:a,format:"rgba32float",scaleMode:"nearest",alphaMode:"no-premultiply-alpha",label:"InstanceIndex"}),this._texture=new w({source:this._source});return}this._source.resource=this.data,(this._source.width!==r||this._source.height!==a)&&this._source.resize(r,a)}upload(){this._source.update()}unload(){this._source?.unload()}destroy(){this._texture&&(this._texture.destroy(!0),this._texture=null,this._source=null,this.data=null)}};function De(e){const t=e?" * 2":"";return{name:e?"morphTargetNormalGl":"morphTargetGl",bindings:{global:{uMorphTexture:"texture_2d<f32>",uGeometryTexture:"texture_2d<f32>"}},gl:{vertex:{header:`
