...
(async () => {
  ...
  const triangle = new Mesh({
    ...
    shader: new Shader({
      ...
      resources: {
        uTexture: (
          await Assets.load('https://pixijs.com/assets/bg_scene_rotate.jpg')
        ).source,
      },
    }),
  });
  ...
  const triangle2 = new Mesh({
    ...
    shader: new Shader({
      glProgram,
      resources: {
        uTexture: (await Assets.load('https://pixijs.com/assets/bg_rotate.jpg'))
          .source,
      },
    }),
  });
  ...
  const triangle3 = new Mesh({
    ...
    shader: new Shader({
      ...
      resources: {
        uTexture: (
          await Assets.load('https://pixijs.com/assets/bg_displacement.jpg')
        ).source,
      },
    }),
  });
