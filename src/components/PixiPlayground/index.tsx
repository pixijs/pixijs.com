...
}): JSX.Element
{
  ...
  return (
    <SandpackLayout
      className={`${styles[props.mode]} ${showOutput ? styles.showOutput : ''}`}
    >
      <MonacoEditor />
      <div className={styles.previewWrapper}>
        <SandpackPreview
          showOpenInCodeSandbox={true}
          className={styles.sandpackPreview}
        />
        {sandpack.bundlerState == null && (
          <div className={styles.sandpackLoadingOverlay}></div>
        )}
      </div>
