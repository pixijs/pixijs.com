...
export default function Team(): JSX.Element
{
  ...
  return (
    ...
    >
      <main>
        <div
          className={`${styles.header} padding-horiz--lg text--center margin-vert--xl`}
        >
          <h1 className="underline">Meet the Team</h1>
          <h4>
            The Core Team is comprised of a handful of dedicated individuals who
            volunteer their time to make PixiJS better.
          </h4>
        </div>
        <div className={`${styles.members} container flex margin-bottom--xl`}>
