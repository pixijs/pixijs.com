...
const displacementSprite = PIXI.Sprite.from('https://beta.pixijs.com/assets/pixi-filters/displace.png');
...
const ring = PIXI.Sprite.from('https://beta.pixijs.com/assets/pixi-filters/ring.png');
