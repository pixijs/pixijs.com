...
import OriginIndexFile from '!!raw-loader!../docs/examples/container_transform_origin';
import BitmapBreakIndexFile from '!!raw-loader!../docs/examples/text_bitmap_word-wrap_break-words';
import BitmapOverlapIndexFile from '!!raw-loader!../docs/examples/text_bitmap_split-text';
