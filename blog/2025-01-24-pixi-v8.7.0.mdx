...
More details are available in the [Render Layers guide](/8.x/guides/advanced/render-layers).
...
You can find the full API details in the [GIF API Documentation](https://pixijs.download/feature/gif/docs/gif.html).
...
A detailed guide is available [here](/8.x/guides/advanced/mixing-three-and-pixi).
