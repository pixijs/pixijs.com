...
import RenderLayerIndexFile from '!!raw-loader!../docs/examples/rendering_render-layer/index';
import RenderLayerFish from '!!raw-loader!../docs/examples/rendering_render-layer/Fish';
import RenderLayerCharacterUI from '!!raw-loader!../docs/examples/rendering_render-layer/CharacterUI';
import GifIndexFile from '!!raw-loader!../docs/examples/sprite_gif_animation_loading';
import ThreeIndexFile from '!!raw-loader!../docs/examples/three_basic-integration';
