...
import TrimIndexFile from '!!raw-loader!../docs/examples/scene_text_trim';
import FiltersIndexFile from '!!raw-loader!../docs/examples/scene_text_filters';
import CartoonFile from '!!raw-loader!../docs/examples/scene_text_filters/CartoonTextFilter';
import vert from '!!raw-loader!../docs/examples/scene_text_filters/cartoonText.vert';
import frag from '!!raw-loader!../docs/examples/scene_text_filters/cartoonText.frag';
import wgsl from '!!raw-loader!../docs/examples/scene_text_filters/cartoonText.wgsl';
import TextureStyleIndexFile from '!!raw-loader!../docs/examples/scene_text_texture-style';
import NineSliceIndexFile from '!!raw-loader!../docs/examples/scene_nine-slice-sprite_anchor';
import DomContainerIndexFile from '!!raw-loader!../docs/examples/scene_dom-container';
