...
import TrimIndexFile from '!!raw-loader!../docs/examples/text_trim_bounds';
import FiltersIndexFile from '!!raw-loader!../docs/examples/text_filters_cartoon';
import CartoonFile from '!!raw-loader!../docs/examples/text_filters_cartoon/CartoonTextFilter';
import vert from '!!raw-loader!../docs/examples/text_filters_cartoon/cartoonText.vert';
import frag from '!!raw-loader!../docs/examples/text_filters_cartoon/cartoonText.frag';
import wgsl from '!!raw-loader!../docs/examples/text_filters_cartoon/cartoonText.wgsl';
import TextureStyleIndexFile from '!!raw-loader!../docs/examples/text_texture-style_scale-mode';
import NineSliceIndexFile from '!!raw-loader!../docs/examples/nine-slice-sprite_transform_anchor';
import DomContainerIndexFile from '!!raw-loader!../docs/examples/dom-container_html_text-area';
