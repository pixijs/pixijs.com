---
id: "pixi_mesh_extras.SimpleRope"
title: "Class: SimpleRope"
sidebar_label: "SimpleRope"
custom_edit_url: null
---

[@pixi/mesh-extras](../modules/pixi_mesh_extras.md).SimpleRope
...
• **new SimpleRope**(`texture`, `points`, `textureScale?`)
...
| :------ | :------ | :------ | :------ |
| `texture` | `Texture`<`Resource`\> | `undefined` | The texture to use on the rope. |
| `points` | `IPoint`[] | `undefined` | An array of PIXI.Point objects to construct this rope. |
| `textureScale` | `number` | `0` | Optional. Positive values scale rope texture keeping its aspect ratio. You can reduce alpha channel artifacts by providing a larger texture and downsampling here. If set to zero, texture will be stretched instead. |
...
[pixijs/packages/mesh-extras/src/SimpleRope.ts:30](https://github.com/pixijs/pixijs/blob/2194fe5c5/packages/mesh-extras/src/SimpleRope.ts#L30)
...
[pixijs/packages/mesh-extras/src/SimpleRope.ts:20](https://github.com/pixijs/pixijs/blob/2194fe5c5/packages/mesh-extras/src/SimpleRope.ts#L20)
...
[pixijs/packages/mesh-extras/src/SimpleRope.ts:49](https://github.com/pixijs/pixijs/blob/2194fe5c5/packages/mesh-extras/src/SimpleRope.ts#L49)
...
▸ **setTransform**(`x?`, `y?`, `scaleX?`, `scaleY?`, `rotation?`, `skewX?`, `skewY?`, `pivotX?`, `pivotY?`): [`SimpleRope`](pixi_mesh_extras.SimpleRope.md)
...
[`SimpleRope`](pixi_mesh_extras.SimpleRope.md)
