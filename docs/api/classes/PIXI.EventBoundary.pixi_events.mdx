...
### new PIXI.EventBoundary: <span><code>(rootTarget&#58; DisplayObject) </code></span>
...
### dispatch: <span><code>utils.EventEmitter</code></span>
...
### moveOnAll: <span><code>boolean</code></span>
...
### rootTarget: <span><code>DisplayObject</code></span>
...
### eventPool: <span><code>Map&#60;typeof FederatedEvent, FederatedEvent[]&#62;</code></span>
...
### mappingState: <span><code>Record&#60;string, any&#62;</code></span>
...
### mappingTable: <span><code>Record&#60;string, Array&#60;&#123; fn &#58; (e&#58; FederatedEvent) =&#62; void, priority &#58; number &#125;&#62;&#62;</code></span>
...
### addEventMapping: <span><code>(type&#58; string, fn&#58; (e&#58; FederatedEvent) =&#62; void) -&#62; void</code></span>
...
### all: <span><code>(e&#58; FederatedEvent, type&#58; string, target&#58; FederatedEventTarget) -&#62; void</code></span>
...
### dispatchEvent: <span><code>(e&#58; FederatedEvent, type&#58; string) -&#62; void</code></span>
...
### hitTest: <span><code>(x&#58; number, y&#58; number) -&#62; DisplayObject</code></span>
...
### mapEvent: <span><code>(e&#58; FederatedEvent) -&#62; void</code></span>
...
### propagate: <span><code>(e&#58; FederatedEvent, type&#58; string) -&#62; void</code></span>
Propagate the passed event from from [this.rootTarget](../classes/PIXI.EventBoundary.pixi_events#rootTarget) to its target `e.target`.
...
### propagationPath: <span><code>(target&#58; FederatedEventTarget) -&#62; FederatedEventTarget[]</code></span>
Finds the propagation path from [rootTarget](../classes/PIXI.EventBoundary.pixi_events#rootTarget) to the passed`target`. The last element in the path is `target`.
...
### allocateEvent: <span><code>(constructor&#58; &#123; new (boundary&#58; EventBoundary)&#58; T &#125;) -&#62; T</code></span>
Allocate a specific type of event from [this.eventPool](../classes/PIXI.EventBoundary.pixi_events#eventPool).
...
### clonePointerEvent: <span><code>(from&#58; FederatedPointerEvent, type&#58; string) -&#62; FederatedPointerEvent</code></span>
...
### copyData: <span><code>(from&#58; FederatedEvent, to&#58; FederatedEvent) -&#62; void</code></span>
Copies base [PIXI.FederatedEvent](../classes/PIXI.FederatedEvent.pixi_events) data from `from` into `to`.
...
### copyMouseData: <span><code>(from&#58; FederatedEvent, to&#58; FederatedEvent) -&#62; void</code></span>
Copies mouse [PIXI.FederatedMouseEvent](../classes/PIXI.FederatedMouseEvent.pixi_events) data from `from` to `to`.
The following properties are copied&#58;
...
### copyPointerData: <span><code>(from&#58; FederatedEvent, to&#58; FederatedEvent) -&#62; void</code></span>
Copies pointer [PIXI.FederatedPointerEvent](../classes/PIXI.FederatedPointerEvent.pixi_events) data from `from` into `to`.
The following properties are copied&#58;
...
### copyWheelData: <span><code>(from&#58; FederatedWheelEvent, to&#58; FederatedWheelEvent) -&#62; void</code></span>
Copies wheel [PIXI.FederatedWheelEvent](../classes/PIXI.FederatedWheelEvent.pixi_events) data from `from` into `to`.
The following properties are copied&#58;
...
### createPointerEvent: <span><code>(from&#58; FederatedPointerEvent, type&#58; string, target&#58; FederatedEventTarget) -&#62; FederatedPointerEvent</code></span>
...
### createWheelEvent: <span><code>(from&#58; FederatedWheelEvent) -&#62; FederatedWheelEvent</code></span>
...
### findMountedTarget: <span><code>(propagationPath&#58; FederatedEventTarget[]) -&#62; FederatedEventTarget</code></span>
...
### freeEvent: <span><code>(event&#58; T) -&#62; void</code></span>
...
### hitPruneFn: <span><code>(displayObject&#58; DisplayObject, location&#58; Point) -&#62; boolean</code></span>
...
### hitTestFn: <span><code>(displayObject&#58; DisplayObject, location&#58; Point) -&#62; boolean</code></span>
...
### hitTestRecursive: <span><code>(currentTarget&#58; DisplayObject, interactive&#58; Interactive, location&#58; Point, testFn&#58; (object&#58; DisplayObject, pt&#58; Point) =&#62; boolean, pruneFn&#58; (object&#58; DisplayObject, pt&#58; Point) =&#62; boolean) -&#62; DisplayObject[]</code></span>
Recursive implementation for [hitTest](../classes/PIXI.EventBoundary.pixi_events#hitTest).

#### Parameters:
| Name          | Type                                                                   | Description                                                                                                                                                                          |
| ------------- | ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| currentTarget | <code>DisplayObject</code>                                             | The DisplayObject that is to be hit tested.                                                                                                                                          |
| interactive   | <code>Interactive</code>                                               | Flags whether `currentTarget` or one of its parents are interactive.                                                                                                                 |
...
### mapPointerDown: <span><code>(from&#58; FederatedEvent) -&#62; void</code></span>
...
### mapPointerMove: <span><code>(from&#58; FederatedEvent) -&#62; void</code></span>
...
### mapPointerOut: <span><code>(from&#58; FederatedEvent) -&#62; void</code></span>
...
### mapPointerOver: <span><code>(from&#58; FederatedEvent) -&#62; void</code></span>
...
### mapPointerUp: <span><code>(from&#58; FederatedEvent) -&#62; void</code></span>
...
### mapPointerUpOutside: <span><code>(from&#58; FederatedEvent) -&#62; void</code></span>
...
### mapWheel: <span><code>(from&#58; FederatedEvent) -&#62; void</code></span>
...
### notifyTarget: <span><code>(e&#58; FederatedEvent, type&#58; string) -&#62; void</code></span>
...
### trackingData: <span><code>(id&#58; number) -&#62; TrackingData</code></span>
