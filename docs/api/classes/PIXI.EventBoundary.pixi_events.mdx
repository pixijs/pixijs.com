...
**Description:** Enables the global move events. `globalpointermove`, `globaltouchmove`, and `globalmousemove`
...
### all 
**Type:** <code>(e&#58; FederatedEvent, type&#58; string &#124; string[], targets&#58; ) -&#62; void</code>

**Description:** Emits the event `e` to all interactive display objects. The event is propagated in the bubbling phase always.
...
| type    | <code>string &#124; string[]</code> | The listeners to notify. |
| targets |                                     | The targets to notify.   |
</article>
