---
id: "pixi_sprite.Sprite"
title: "Class: Sprite"
sidebar_label: "Sprite"
custom_edit_url: null
---

[@pixi/sprite](../modules/pixi_sprite.md).Sprite
...
| :------ | :------ | :------ |
| `texture?` | `Texture`<`Resource`\> | The texture for this sprite. |

#### Inherited from

GlobalMixins.Sprite.constructor

#### Defined in

[pixijs/packages/sprite/src/Sprite.ts:139](https://github.com/pixijs/pixijs/blob/2194fe5c5/packages/sprite/src/Sprite.ts#L139)
...
GlobalMixins.Sprite.\_tintedCanvas
...
GlobalMixins.Sprite.\_renderCanvas
...
[pixijs/packages/sprite/src/Sprite.ts:460](https://github.com/pixijs/pixijs/blob/2194fe5c5/packages/sprite/src/Sprite.ts#L460)
...
▸ **setTransform**(`x?`, `y?`, `scaleX?`, `scaleY?`, `rotation?`, `skewX?`, `skewY?`, `pivotX?`, `pivotY?`): [`Sprite`](pixi_sprite.Sprite.md)
...
▸ `Static` **from**(`source`, `options?`): [`Sprite`](pixi_sprite.Sprite.md)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `source` | [`SpriteSource`](../modules/pixi_sprite.md#spritesource) | Source to create texture from |
