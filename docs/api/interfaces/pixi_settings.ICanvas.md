---
id: "pixi_settings.ICanvas"
title: "Interface: ICanvas"
sidebar_label: "ICanvas"
custom_edit_url: null
---

[@pixi/settings](../modules/pixi_settings.md).ICanvas
...
• `Optional` `Readonly` **parentNode**: [`ICanvasParentNode`](pixi_settings.ICanvasParentNode.md)
...
• `Optional` `Readonly` **style**: [`ICanvasStyle`](pixi_settings.ICanvasStyle.md)
...
| Name | Type |
| :------ | :------ |
| `K` | extends keyof [`WebGLContextEventMap`](pixi_settings.WebGLContextEventMap.md) |
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`ICanvas`](pixi_settings.ICanvas.md), `ev`: [`WebGLContextEventMap`](pixi_settings.WebGLContextEventMap.md)[`K`]) => `any` |
...
▸ `Optional` **getBoundingClientRect**(): [`ICanvasRect`](pixi_settings.ICanvasRect.md)

Get the position and the size of the canvas.

#### Returns

[`ICanvasRect`](pixi_settings.ICanvasRect.md)
...
▸ **getContext**(`contextId`, `options?`): [`ICanvasRenderingContext2D`](pixi_settings.ICanvasRenderingContext2D.md)
...
| `options?` | [`ICanvasRenderingContext2DSettings`](pixi_settings.ICanvasRenderingContext2DSettings.md) | The options for creating context. |

#### Returns

[`ICanvasRenderingContext2D`](pixi_settings.ICanvasRenderingContext2D.md)
...
▸ **getContext**(`contextId`, `options?`): [`RenderingContext`](../modules/pixi_settings.md#renderingcontext)

#### Parameters

| Name | Type |
| :------ | :------ |
| `contextId` | [`ContextIds`](../modules/pixi_settings.md#contextids) |
| `options?` | [`ContextSettings`](../modules/pixi_settings.md#contextsettings) |

#### Returns

[`RenderingContext`](../modules/pixi_settings.md#renderingcontext)
