---
description: Learn how to combine PixiJS and Three.js to create dynamic applications that leverage both 2D and 3D graphics.
---
...
{/* embedded:@site/docs/examples/advanced/three-and-pixi.js */}
<EmbeddedEditor files={{"index.js": ThreePixiIndexFile}} dependencies={{ "three": "latest", "pixi.js": "latest" }} />
<br/>
